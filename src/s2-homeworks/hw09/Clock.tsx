...
function Clock() {
  const [timerId, setTimerId] = useState<number | undefined>(undefined) //useState хранит ID, чтобы он был доступен во всем компоненте в любое время. setTimerId(id) записывает этот ID в память после запуска
